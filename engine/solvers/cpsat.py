...
def _build_and_solve(
    *,
    ...
    if b9_pairs:
        ...
        b9_excess = model.NewIntVar(0, 20, "b9_eng_adj_excess")
        model.Add(b9_excess >= b9_sum - 1)
        model.Add(b9_excess >= 0)
        soft_terms.append((cfg.weight_adjacent, b9_excess))
...
def solve(inputs_dir: Path, out_root: Path, config: Optional[SolverConfig] = None) -> Dict[str, Any]:
