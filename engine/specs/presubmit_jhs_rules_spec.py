...
def test_jhs_english_ok(tmp_path: Path) -> None:
    ...
    rows = [
        ...
        # B9: Wed & Fri present; <=1 daily double across week; Fri T9 English enforced separately in other test
        ("B9", "Wednesday", "12:15", "13:00", "English", "Sir Bright Dey"),
        ("B9", "Friday", "14:25", "15:10", "English", "Sir Bright Dey"),
...
def test_jhs_english_wrong_days(tmp_path: Path) -> None:
    ...
    rows = [
        ...
        ("B9", "Friday", "15:15", "16:00", "English", "Sir Bright Dey"),
        ("B9", "Monday", "08:30", "09:15", "English", "Sir Bright Dey"),
        ("B9", "Tuesday", "09:15", "10:00", "English", "Sir Bright Dey"),
    ]
...
def test_b9_fri_t9_not_english(tmp_path: Path) -> None:
    ...
    rows = [
        ("B9", "Friday", "15:15", "16:00", "Extra Curricular", "EC1"),
    ]
